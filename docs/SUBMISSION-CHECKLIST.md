...
| 4 | Screen recording / demo video URL of the workflow | ✅ | `docs/demo/escrow-sentinel-demo.mp4` (75 MB, in-repo) — raw URL <https://raw.githubusercontent.com/summerlx0416-droid/escrow-sentinel/master/docs/demo/escrow-sentinel-demo.mp4> |
